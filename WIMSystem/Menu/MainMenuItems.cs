...
namespace WIMSystem.Menu
{
    internal static class MainMenuItems
    {
        ...
        {
            new MenuItem("CreateMember","* Create a new person","Enter person name:"),
            ...
            new MenuItem("CreateNewBoard","* Create a new board in a team", "Enter team name and board name:"),
            ...
            new MenuItem("CreateBug","* Create a new Bug in a board", "Enter bug title, description, stepsto reproduce (divided by comma), priority, severity, board"),
            new MenuItem("CreateStory","* Create a new Story in a board", "Enter story title, description, priority, storySize, board:"),
            new MenuItem("CreateFeedback","* Create a new Feedback in a board", "Enter feedback title, description, rating, board"),
            ...
            new MenuItem("AssignWorkItemToMember","* Assign work item to a person", "Enter work item title and member name"),
            new MenuItem("UnassignWorkItemToMember","* Unassign work item to a person", "Enter work item team name, board name, work item title, member name"),
